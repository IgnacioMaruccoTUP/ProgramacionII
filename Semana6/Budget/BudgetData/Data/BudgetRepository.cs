    ...
    public class BudgetRepository : IBudgetRepository
    {
        public List<Budget> GetAll()
        {
            ...
            List<SqlParameter> param = new List<SqlParameter>() {
                //new SqlParameter("@fecha_desde", DateTime.Now) ,
                //new SqlParameter("@fecha_hasta", DateTime.Now) ,
                //new SqlParameter("@cliente", "pepe")

            };
            
            var t = helper.ExecuteSPQuery("SP_RECUPERAR_PRESUPUESTOS", param);
        ...
        public bool Update(Budget oBudget)
        {
            ...
            try
            {
                ...
                var cmd = new SqlCommand("SP_EDITAR_PRESUPUESTO", cnn, t);
                cmd.CommandType = CommandType.StoredProcedure;
